...
from scanner.views.tokenlist_editor import tokenlist_editor
...
urlpatterns = [
    ...
    path('tokenlist/', tokenlist_editor, name='tokenlist_editor'),
    ...
    # ──────────────── 🔑 Password Finder ────────────────
    path('password_finder/', password_finder.password_finder_input, name='password_finder_input'),
    path('password_finder/start/', password_finder.start_password_finder, name='start_password_finder'),
    path('password_finder/stop/', password_finder.stop_password_finder, name='stop_password_finder'),
    path('password_finder/check-recovery-status/', password_finder.check_recovery_status, name='check_password_finder_status'),
    path('password_finder/result/', password_finder.password_finder_result, name='password_finder_result'),
    path('password_finder/download/pdf/', password_finder.download_recovery_report, name='download_password_finder_report_pdf'),
    ...
    path('passphrase_finder/check-recovery-status/', passphrase_finder.check_passphrase_status, name='check_passphrase_status'),
    path('passphrase_finder/result/', passphrase_finder.passphrase_finder_result, name='passphrase_finder_result'),
    path('passphrase_finder/open-list-file/<str:filename>/', passphrase_finder.open_list_file, name='open_passphrase_list_file'),
    path('passphrase_finder/download/pdf/', passphrase_finder.download_recovery_report, name='download_passphrase_finder_report_pdf'),
